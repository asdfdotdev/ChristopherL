/**
 * Sitewide JavaScript - Bringing the swoopy.
 * Includes Featherlight.js and Parsley.js
 * For full details please see the unminified version of this file.
 *
...
!function(t){t(function(){function e(t){var e=!1;return"undefined"!=typeof t&&void 0!==t&&""!=t&&(e=!0),e}t("a").on("click",function(e){var i=t(this),n=i.attr("href");"_blank"!==i.attr("target")&&"undefined"!=typeof n&&0!==n.indexOf("javascript:")&&0!==n.indexOf("#")&&(e.preventDefault(),t(document).one("ga_track_complete",function(){window.location.href=n})),t(document).trigger("ga_track",[{type:"link_click",identifier:{dom_data:i.attr("data-event"),dom_id:i.attr("id")},target:n}])}),t("img, span.egg, .play-button").on("click",function(e){if(!t(this).parent().is("a")){var i=t(this);t(document).trigger("ga_track",[{type:"other_click",identifier:{dom_data:i.attr("data-event"),dom_id:i.attr("id")},target:i.attr("src")}])}}),t(document).on("ga_track",function(i,n){try{var a=[];"object"==typeof n.identifier?(e(n.identifier.dom_data)&&a.push(n.identifier.dom_data),e(n.identifier.dom_id)&&a.push(n.identifier.dom_id),e(n.identifier.dom_name)&&a.push(n.identifier.dom_name)):"string"==typeof n.identifier&&a.push(n.identifier),null!=n.target&&a.push(n.target),ga("send","event",window.location.href,n.type,a.join(" | "),{hitCallback:function(){t(document).trigger("ga_track_complete")}})}catch(r){}finally{setTimeout(function(){t(document).trigger("ga_track_complete")},500)}})})}(jQuery);
